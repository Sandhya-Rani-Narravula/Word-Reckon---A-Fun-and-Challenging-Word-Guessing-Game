  ...
  $scope.answerChanged = function(){
      if($scope.inputMode === 'letter'){
        ...
        if(index > -1){
            ...
            for(let i=0; i< $scope.answerToCheck.length; i++) {
                var index1 = $scope.answerToCheck.indexOf($scope.userGuess);
                console.log('index :',index1); 
                $scope.lettersMatched[index1] = $scope.userGuess;
                $scope.answerToCheck[index1] = "-";
            }
